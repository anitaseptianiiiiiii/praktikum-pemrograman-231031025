...
print('====================Latihan LIST====================\n')
#Latihan LIST
data = ['Anita Septiani Mustamin',2023,'Aktif']
nilai= [90,89,93,97]
...
print(f'\nProgram pendidikan Anita Septiani Mustamin: {data[3][0]}\n')
print(f'Angkatan : {data[0][1]}-{data[3][1]}\n')
print(f'Jumlah nilai Anita Septiani Mustamin adalah : {len(data[1])}\n')
print(f'Data terbesar Anita Septiani Mustamin adalah : {max(data[1])}\n')
print(f'Data terkecil Anita Septiani Mustamin adalah : {min(data[1])}\n')
print(f'rata-rata nilai Anita Septiani Mustamin adalah : {sum(data[1])/len(data[1])}\n')
